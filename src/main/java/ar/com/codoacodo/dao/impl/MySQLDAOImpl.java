...
public class MySQLDAOImpl implements DAO {
    ...
    public Articulo getById(Long id) { // 1
        return new Libro(tableName, tableName, 0, tableName, false, tableName, tableName, null);
    }
    ...
    private Date dateFrom(LocalDateTime ltd) {
        java.util.Date date = Date.from(ltd.toLocalDate().atStartOfDay(ZoneId.systemDefault()).toInstant());
